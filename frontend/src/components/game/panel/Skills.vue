<template>
  <div class="skills-region flex flex-col">
    <div class="skills-view flex flex-col">
      <div class="core-skills-region skills action-boxes" v-if="customSkills1.length || customSkills2.length">
        <div class="skill-boxes">
            <div class="box-row" v-if="customSkills1.length">
              <div
            ...
            <div class="box-row" v-if="customSkills2.length">
              <div
                class="box-item no-touch"
                :class="{ disabled: skill.is_disabled }"
...
const worldCustomSkills = computed(() => store.state.game.world.skills?.definitions || {});
