...
const routes = [
  ...
  // Builder
  {
    ...
    children: [
      ...
      { path: 'trainerprofiles', name: 'builder_trainer_profile_list', component: () => import('@/views/builder/world/TrainerProfileList.vue') },
      { path: 'trainerprofiles/:trainer_profile_id', name: 'builder_trainer_profile_details', component: () => import('@/views/builder/world/TrainerProfileDetails.vue') },
