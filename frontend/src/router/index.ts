...
const routes = [
  ...
  // Builder
  {
    ...
    children: [
      ...
      { path: 'zones/:zone_id/spawn-plans', name: 'builder_zone_spawn_plan_list', component: () => import('@/views/builder/zone/SpawnPlanList.vue') },
      { path: 'zones/:zone_id/spawn-plans/:spawn_plan_id', name: 'builder_zone_spawn_plan_details', component: () => import('@/views/builder/zone/SpawnPlanDetails.vue') },
      ...
      { path: 'rooms/:room_id/spawn-plans', name: 'builder_room_spawn_plan_list', component: () => import('@/views/builder/room/SpawnPlans.vue') },
