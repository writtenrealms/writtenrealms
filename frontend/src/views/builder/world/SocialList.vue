<template>
  <EditableCollection
    ...
    <p>For more information, refer to the <a href="https://docs.writtenrealms.com/builders/social-builder-guide" target="_blank" rel="noopener noreferrer">social builder guide.</a></p>
