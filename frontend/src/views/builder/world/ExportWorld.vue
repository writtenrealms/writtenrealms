<template>
  <div id="world-export">
    ...
    <div v-if="summary" class="color-text-60 mb-4">
      {{ summary.documents }} documents: {{ summary.currencies }} currencies, {{ summary.craft_materials }} craft materials, {{ summary.crafting_recipes }} crafting recipes, {{ summary.crafting_profiles }} crafting profiles, {{ summary.zones }} zones, {{ summary.rooms }} rooms, {{ summary.paths }} paths, {{ summary.item_definitions }} items, {{ summary.item_bundles }} item bundles, {{ summary.mob_definitions }} mobs, {{ summary.spawn_plans }} spawn plans, {{ summary.quest_arcs }} quest arcs, {{ summary.quests }} quests, and {{ summary.triggers }} triggers.
    </div>
