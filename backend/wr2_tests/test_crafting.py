...
class TestCraftingMutation(CraftingRuntimeTestCase):
    ...
    def test_history_reference_cannot_start_a_command_chain(self):
        self._assert_history_chain_is_rejected("!1 ; craft blue crested helm")

    def test_history_reference_cannot_end_a_command_chain(self):
        self._assert_history_chain_is_rejected("craft blue crested helm ; !1")
