...
api_v1_urls = [
    ...
    path('builder/worlds/<world_pk>/abilities/', builder_views.world_ability_list, name='builder-world-ability-list'),
    path('builder/worlds/<world_pk>/abilities/<pk>/', builder_views.world_ability_detail, name='builder-world-ability-detail'),
    ...
    path('builder/worlds/<world_pk>/itemdefinitions/<pk>/power/', builder_views.item_definition_power, name='builder-item-definition-power'),
    ...
    path('builder/worlds/<world_pk>/mobdefinitions/<pk>/power/', builder_views.mob_definition_power, name='builder-mob-definition-power'),
    path('builder/worlds/<world_pk>/mobdefinitions/<pk>/reactions/', builder_views.mob_definition_reactions, name='builder-mob-definition-reactions'),
    path('builder/worlds/<world_pk>/mobdefinitions/<mob_definition_pk>/reactions/<pk>/', builder_views.mob_definition_reaction_detail, name='builder-mob-definition-reaction-detail'),
